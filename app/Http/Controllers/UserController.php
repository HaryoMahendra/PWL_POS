...
class UserController extends Controller
{
    ...
    {
        $request->validate([
            'username' => 'required|string|min:3|unique:m_user,username,'.$id.',user_id', //username harus diisi, harus string, minimal 3 karakter, dan harus unik di tabel m_user kecuali untuk data dengan id tertentu
            'nama' => 'required|string|max:100', //nama harus diisi, harus string, dan maksimal 100 karakter
            'password' => 'nullable|min:5', //password boleh diisi atau tidak, jika diisi minimal 5 karakter
            'level_id' => 'required|integer' //level_id harus diisi dan harus angka
        ]);
